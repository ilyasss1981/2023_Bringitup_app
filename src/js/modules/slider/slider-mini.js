    ...
    init() {
        try {
            ...
            if (this.autoplay) {
                ...
                this.next.parentNode.addEventListener('mouseenter', () => {clearInterval(this.paused)});
                this.next.parentNode.addEventListener('mouseleave', () => {this.activateAutoplay()});

                this.container.addEventListener('mouseenter', () => {clearInterval(this.paused)});
                this.container.addEventListener('mouseleave', () => {this.activateAutoplay()});
            }
        } catch(e){};
    }
}